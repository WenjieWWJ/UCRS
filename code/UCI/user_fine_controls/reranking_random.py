...
print('All predicted users\' number is ' + str(len(user_target)))
...
for userID in user_target:
    ...
    indices = random.sample(range(len(predictions)), eval(args.topN)[-1])
...
#     evaluate.print_results(None, None, test_results)
...
all_user_num, extreme_user_num = get_GA_GD_all_threshold(threshold_proportion_list,
                                                         ...
                                                         threshold_group_number, user_target)
